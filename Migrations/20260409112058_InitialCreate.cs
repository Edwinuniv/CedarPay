        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeTransactionThreshold = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiverWalletSerial = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ReceiverBankName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TopUps_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderCurrencyId = table.Column<int>(type: "int", nullable: false),
                    ReceiverCurrencyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "USD", 1.0m, "/images/flags/usd.png", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "US Dollar", "$" },
                    { 2, "EUR", 1.08m, "/images/flags/eur.png", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Euro", "€" },
                    { 3, "LBP", 0.000011m, "/images/flags/lbp.png", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lebanese Pound", "ل.ل" },
                    { 4, "AED", 0.27m, "/images/flags/aed.png", true, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "UAE Dirham", "د.إ" }
                });

            migrationBuilder.InsertData(
                table: "FeePolicies",
                columns: new[] { "Id", "CreatedAt", "FeePercentage", "FixedFee", "FreeTransactionThreshold", "IsActive", "Name" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0.02m, 0.50m, 10, true, "Standard" });
